...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .overlay-container { width: 50%; height: 100%; background: linear-gradient(135deg, #7c3aed, #4c1d95); border-radius: 120px 0 0 120px; color: white; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 0 50px; position: relative; }
        ...
        .forgot-password:hover { color: #7c3aed; text-decoration: underline; }
...
<body>
    <div class="auth-container">
        ...
        <div class="overlay-container">
            ...
            <a href="<?php echo e(route('register')); ?>" style="width: 100%; display: flex; justify-content: center; text-decoration: none;">
...
<?php /**PATH C:\Nada PAW1\tugas_uas\resources\views/auth/login.blade.php ENDPATH**/ ?>