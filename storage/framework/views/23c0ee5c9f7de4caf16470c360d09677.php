...
<div class="fixed top-24 left-1/2 -translate-x-1/2 z-50 bg-green-100 border border-green-400 text-green-800 px-6 py-4 rounded-xl shadow-lg flex items-center gap-3 max-w-lg" id="flash-msg">
    ...
    <p class="font-label-md"><?php echo e(session('success')); ?></p>
...
<div class="fixed top-24 left-1/2 -translate-x-1/2 z-50 bg-red-100 border border-red-400 text-red-800 px-6 py-4 rounded-xl shadow-lg max-w-lg">
    ...
    <p class="font-label-md"><?php echo e($error); ?></p>
...
<form method="POST" action="<?php echo e(route('upload-resep.store')); ?>" enctype="multipart/form-data" class="glass-card rounded-2xl p-8 shadow-md space-y-8">
<!-- Drag & Drop Area -->
<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.sipa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Nada PAW1\tugas_uas\resources\views/upload-resep.blade.php ENDPATH**/ ?>