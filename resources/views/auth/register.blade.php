...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .overlay-container { width: 50%; height: 100%; background: linear-gradient(135deg, var(--color-primary), var(--color-on-primary-fixed-variant)); border-radius: 0 120px 120px 0; color: white; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 0 50px; position: relative; }
