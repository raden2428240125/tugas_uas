        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-bottom">
                    <h3 class="card-title fw-bold text-primary m-0"><i class="bi bi-cart-plus me-2"></i>Tambah Pesanan</h3>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="resep_id" class="form-select">
                                    ...
                                    @foreach ($resep as $item)
                                        <option value="{{ $item->id }}" {{ old('resep_id') == $item->id ? 'selected' : '' }}>
                                            Resep #{{ $item->id }} - {{ $item->pelanggan->nama ?? '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6">
