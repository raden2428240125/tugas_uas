...
<style>
    ...
    .map-placeholder {
        background: linear-gradient(135deg, #bbf7d0 0%, #e2e8f0 30%, #f1f5f9 60%, #f8fafc 100%);
        position: relative;
        overflow: hidden;
    }
    .map-placeholder::before {
        ...
        inset: 0;
        background:
            linear-gradient(90deg, transparent 49.5%, #cbd5e130 49.5%, #cbd5e130 50.5%, transparent 50.5%),
            linear-gradient(0deg, transparent 49.5%, #cbd5e130 49.5%, #cbd5e130 50.5%, transparent 50.5%);
