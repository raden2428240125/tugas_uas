...
<a class="flex items-center gap-4 text-on-surface-variant p-3 hover:bg-surface-container-high rounded-xl transition-all" href="{{ url('/katalog') }}">
<span class="material-symbols-outlined">vaccines</span>
<span class="font-semibold text-[14px]">Cari Obat</span>
</a>
<a class="flex items-center gap-4 text-on-surface-variant p-3 hover:bg-surface-container-high rounded-xl transition-all" href="{{ url('/upload-resep') }}">
<span class="material-symbols-outlined">description</span>
<span class="font-semibold text-[14px]">Resep Saya</span>
</a>
<a class="flex items-center gap-4 text-on-surface-variant p-3 hover:bg-surface-container-high rounded-xl transition-all" href="{{ url('/riwayat-pesanan') }}">
<span class="material-symbols-outlined">receipt_long</span>
<span class="font-semibold text-[14px]">Riwayat Transaksi</span>
</a>
<a class="flex items-center gap-4 bg-primary text-on-primary rounded-xl p-3 shadow-md" href="{{ url('/profil') }}">
<span class="material-symbols-outlined">person</span>
<span class="font-semibold text-[14px]">Pengaturan Akun</span>
</a>
<a class="flex items-center gap-4 text-on-surface-variant p-3 hover:bg-surface-container-high rounded-xl transition-all" href="{{ url('/lokasi-apotek') }}">
...
<a href="{{ url('/upload-resep') }}" class="w-full py-3 bg-primary text-on-primary rounded-xl font-bold text-[14px] shadow-sm hover:opacity-90 transition-all flex justify-center text-center">
                Unggah Resep
            </a>
</div>
</aside>
